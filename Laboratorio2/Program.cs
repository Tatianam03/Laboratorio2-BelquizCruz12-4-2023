...
do
{
    ...
    switch (op)
    {
        case 1:
            ...
            Console.WriteLine("Ingrese parcial 2: ");
            ...
            Console.WriteLine($"Su resutado es {Math.Round(Convert.ToDecimal(notas.Resultado), 2)}");
        ...
        case 2:
            foreach (var lista in clnotas.Listar())
            {
                ...
                Console.WriteLine($"Nota Laboatorio 3: {lista.Lab3}");
